 ...
 *
 */
public final class GroovyContext extends SimpleContext {
     ...
     */
    public GroovyContext(final Map initialVars) {
        super(initialVars);
        getVars().put("_builtin", new Builtin());
    }
    ...
    //These don't appear to return correctly from super... I don't know about changing them either...
    @Override
